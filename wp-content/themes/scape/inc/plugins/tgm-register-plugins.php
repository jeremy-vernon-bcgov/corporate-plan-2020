...
function wtbx_required_plugins() {
    ...
    $plugins = array(
	    array(
		    ...
		    'source'             => 'http://whiteboxstud.io/envato/scape/dist/63999/scape-core.zip', // The plugin source.
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		    'version'            => '1.4.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
	    ...
	    array(
		    ...
		    'source'             => 'http://whiteboxstud.io/envato/scape/dist/63999/js_composer.zip', // The plugin source.
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required.
	    ...
	    array(
		    ...
		    'source'             => 'http://whiteboxstud.io/envato/scape/dist/63999/revslider.zip', // The plugin source.
	    ...
	    array(
		    ...
		    'source'             => 'http://whiteboxstud.io/envato/scape/dist/63999/envato-market.zip', // The plugin source.
		    'required'           => false, // If false, the plugin is only 'recommended' instead of required.
