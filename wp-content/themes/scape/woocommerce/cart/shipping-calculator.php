...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php printf( '<p><a href="#" class="shipping-calculator-button">%s</a></p>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
	...
	<section class="shipping-calculator-form clearfix" style="display:none;">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button wtbx-button wtbx-button-secondary button-xs"><?php esc_html_e( 'Update Totals', 'woocommerce' ); ?></button></p>
